        ...
        <header className="header">
            <div className="header__container">
                <div className="header__logo">
                    <Link to="/" className="header__logo-link">RELATOS DE PAPEL</Link>
                </div>
                ...
                <nav className="header__nav">
                    <ul className="header__menu">
                        ...
                        <li className="header__menu-item">
                            <Link to="/about" className="header__menu-link">Sobre Nosotros</Link>
                        </li>
                        <li className="header__menu-item">
                ...
                <div className="header__action">
                    <Link to="/login" className="header__action-button">Iniciar Sesión</Link>
                </div>
